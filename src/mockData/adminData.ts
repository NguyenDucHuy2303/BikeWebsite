...
export const initialConfigs: Config[] = [
  // SEO configs
  {
    config_id: 1,
    key: "seo_title_home",
    value: "GreenBike - Xe đạp điện hàng đầu Việt Nam",
    group: "seo",
  },
  {
    config_id: 2,
    key: "seo_description_home",
    value:
      "Chuyên sản xuất và phân phối xe đạp điện chất lượng cao với công nghệ tiên tiến",
    group: "seo",
  },
  {
    config_id: 3,
    key: "seo_title_about",
    value: "Về chúng tôi - GreenBike",
    group: "seo",
  },
  {
    config_id: 4,
    key: "seo_description_about",
    value:
      "Tìm hiểu về GreenBike - Đơn vị tiên phong trong lĩnh vực xe đạp điện",
    group: "seo",
  },
  {
    config_id: 5,
    key: "seo_title_products",
    value: "Sản phẩm - GreenBike",
    group: "seo",
  },
  {
    config_id: 6,
    key: "seo_description_products",
    value: "Khám phá các dòng xe đạp điện GreenBike với đa dạng mẫu mã",
    group: "seo",
  },
  {
    config_id: 7,
    key: "seo_title_news",
    value: "Tin tức - GreenBike",
    group: "seo",
  },
  {
    config_id: 8,
    key: "seo_description_news",
    value: "Cập nhật tin tức mới nhất về xe đạp điện và ngành công nghiệp xanh",
    group: "seo",
  },
  ...
  { config_id: 11, key: "contact_zalo", value: "0123456789", group: "contact" },
  {
    ...
    value: "https://facebook.com/greenbike",
    group: "contact",
  },
  {
    config_id: 13,
  ...
  },
  {
    ...
    value: "456 Đường XYZ, Quận 3, TP.HCM",
    group: "contact",
  },
];
...
export const initialProducts: Product[] = [
  {
    ...
    detailed_description:
      "<p>GreenBike City Pro là dòng xe đạp điện cao cấp được thiết kế đặc biệt cho việc di chuyển trong thành phố.</p>",
    is_active: true,
    seo_title: "GreenBike City Pro - Xe đạp điện cao cấp",
    seo_description:
      "Xe đạp điện GreenBike City Pro với động cơ mạnh mẽ, thiết kế hiện đại",
  },
  {
    product_id: 2,
    series_id: 1,
    ...
    detailed_description:
      "<p>GreenBike Urban mang đến trải nghiệm di chuyển tối ưu trong môi trường đô thị.</p>",
    is_active: true,
    seo_title: "GreenBike Urban - Xe đạp điện đô thị",
    seo_description:
      "Xe đạp điện GreenBike Urban - lựa chọn hoàn hảo cho cuộc sống thành phố",
  },
];
...
export const initialNews: News[] = [
  {
    ...
    content:
      "<p>GreenBike tự hào giới thiệu dòng xe đạp điện City Pro 2024 với nhiều cải tiến vượt trội về công nghệ và thiết kế.</p>",
    tags: ["Sản phẩm mới", "Công nghệ", "City Bike"],
    is_hidden: false,
    created_at: "2024-01-15T10:00:00Z",
    seo_title: "Ra mắt GreenBike City Pro 2024",
    seo_description:
      "Khám phá dòng xe đạp điện GreenBike City Pro 2024 với công nghệ tiên tiến",
  },
  {
    news_id: 2,
    ...
    content:
      "<p>Thị trường xe đạp điện Việt Nam đang có những chuyển biến tích cực với nhiều xu hướng mới.</p>",
  ...
  },
  {
    ...
    content:
      "<p>Hướng dẫn chi tiết cách bảo dưỡng xe đạp điện để kéo dài tuổi thọ và hiệu suất sử dụng.</p>",
