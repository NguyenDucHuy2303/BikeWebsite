...
export function NewsPage({ onNavigate }: NewsPageProps) {
  const featuredNews = {
    ...
    excerpt: 'GreenBike tự hào giới thiệu dòng xe đạp điện thể thao mới với động cơ 500W, pin dung lượng cao và thiết kế aerodynamic hiện đại.',
  ...
  const newsList = [
    {
      ...
      excerpt: 'Giảm giá đến 20% cho tất cả các dòng xe đạp điện, tặng kèm phụ kiện trị giá 2 triệu đồng và hỗ trợ trả góp 0% lãi suất.',
    ...
    },
    {
      ...
      excerpt: 'Mở rộng hệ thống phân phối với showroom rộng 500m² tại trung tâm Đà Nẵng, phục vụ khách hàng khu vực miền Trung.',
      image: 'https://images.unsplash.com/photo-1690291497543-4de63fa4fa75?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
      date: '28/09/2024',
      author: 'Lê Văn Tuấn',
      category: 'Sự Kiện'
    },
    {
      ...
      excerpt: 'Toàn bộ dòng sản phẩm xe đạp điện GreenBike đã được cấp chứng nhận CE, khẳng định chất lượng đạt tiêu chuẩn châu Âu.',
    ...
    },
    {
      ...
      excerpt: 'Chia sẻ kinh nghiệm và hướng dẫn chi tiết cách bảo dưỡng xe đạp điện để kéo dài tuổi thọ pin và động cơ.',
      image: 'https://images.unsplash.com/photo-1675798227643-da319f8ee8f7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
      date: '15/09/2024',
      author: 'Nguyễn Văn Minh',
      category: 'Hướng Dẫn'
    },
    {
      ...
      excerpt: 'Trưng bày 15 mẫu xe đạp điện mới nhất tại triển lãm ô tô - xe máy quốc tế Việt Nam lần thứ 16.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Cập nhật những tin tức mới nhất về sản phẩm, khuyến mãi và hoạt động của GreenBike
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-green-700 to-green-600 text-white p-12 rounded-2xl shadow-lg text-center">
          ...
          <p className="text-green-100 mb-6 max-w-2xl mx-auto">
            Nhận thông tin sớm nhất về sản phẩm mới, chương trình khuyến mãi hấp dẫn và các sự kiện của GreenBike
          </p>
