...
export function AdminProductsPage({ products, series, onEdit, onDelete, onAdd, onViewDetail }: AdminProductsPageProps) {
        ...
        <div className="mb-12 flex items-end justify-between">
          <div>
            ...
            <p className="text-gray-600 max-w-2xl">
              Quản lý các sản phẩm xe đạp điện của cửa hàng. Thêm mới, chỉnh sửa hoặc xóa sản phẩm.
            </p>
          </div>
          <Button onClick={onAdd} className="gap-2 bg-green-600 hover:bg-green-700">
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute top-3 right-3">
                  <Badge 
                    ...
                    className={product.is_active ? 'bg-green-600' : 'bg-gray-500'}
                  >
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <h3 className="group-hover:text-gray-600 transition">{product.name}</h3>
