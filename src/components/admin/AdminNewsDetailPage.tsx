...
export function AdminNewsDetailPage({ newsId, onNavigate, onEdit, onDelete }: AdminNewsDetailPageProps) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 bg-green-50 border border-green-200 rounded-xl p-6">
          ...
          <p className="text-green-700 text-sm">
            Bài viết này có thể được chỉnh sửa hoặc xóa bằng các nút ở phía trên. 
            Sau khi chỉnh sửa, thay đổi sẽ được áp dụng ngay lập tức trên trang khách hàng.
          </p>
        </div>
      </div>
