...
export function AdminNewsPage({ news, onEdit, onDelete, onAdd, onViewDetail }: AdminNewsPageProps) {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <Badge variant={featuredNews.is_hidden ? 'secondary' : 'default'}>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-4 text-gray-500 mb-4">
                      <div className="flex items-center gap-1">
                        <Calendar size={16} />
                        <span className="text-sm">{formatDate(newsItem.created_at)}</span>
                      </div>
                    </div>
