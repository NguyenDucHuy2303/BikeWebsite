...
export function AdminSeriesPage({ series, onAdd, onEdit, onDelete }: AdminSeriesPageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={isAdding || editSeries !== null} onOpenChange={resetForm}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{editSeries ? 'Sửa dòng xe' : 'Thêm dòng xe mới'}</DialogTitle>
            <DialogDescription>
              Nhập thông tin dòng xe
            </DialogDescription>
          </DialogHeader>
      ...
      <AlertDialog open={deleteId !== null} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xóa dòng xe này? Hành động này không thể hoàn tác.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
