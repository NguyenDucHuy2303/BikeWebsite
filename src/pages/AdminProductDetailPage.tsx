...
export function AdminProductDetailPage({
  ...
  // Mock product line data based on productId - Same as ProductDetailPage
  const productLines = [
    {
      id: 1,
      ...
      description:
        "Dòng xe đạp điện thành phố GreenBike được thiết kế tối ưu cho việc di chuyển hàng ngày trong đô thị. Với khung xe nhẹ, thiết kế gọn gàng và pin bền bỉ, đây là lựa chọn hoàn hảo cho người đi làm, đi học hoặc đi chợ. Trang bị phanh đĩa an toàn, đèn LED chiếu sáng và yên xe êm ái.",
      galleryImages: [
      ...
      sections: [
        {
          ...
          content:
            "Trang bị động cơ brushless 350W với công nghệ tiết kiệm năng lượng, cho phép tốc độ tối đa 25km/h. Hệ thống trợ lực thông minh với 3 chế độ (Eco, Normal, Sport) giúp tối ưu hóa pin theo nhu cầu sử dụng. Khả năng leo dốc lên đến 15 độ.",
          image:
        ...
        },
        {
          ...
          content:
            "Sử dụng pin lithium 48V-12Ah của Samsung SDI, cho phép di chuyển 50-70km mỗi lần sạc đầy. Thời gian sạc nhanh chỉ 4-5 giờ. Pin được bảo vệ bằng hệ thống BMS (Battery Management System) chống quá sạc, quá phóng và ngắn mạch.",
          image:
        ...
        },
        {
          ...
          content:
            "Hệ thống phanh đĩa cơ học trước sau đảm bảo an toàn tuyệt đối. Đèn LED chiếu sáng công suất cao, còi điện, gương chiếu hậu và giỏ đựng đồ tiện lợi. Yên xe thiết kế ergonomic êm ái cho hành trình dài.",
          image:
      ...
      specifications: [
        ...
        { label: "Tốc độ t��i đa", value: "25 km/h" },
    ...
    },
    {
      ...
      description:
        "Dòng xe đạp điện địa hình GreenBike Mountain được chế tạo cho những ai đam mê khám phá. Với động cơ mạnh mẽ 750W, pin dung lượng lớn và hệ thống giảm sóc thủy lực, chiếc xe này có thể chinh phục mọi địa hình từ đường núi, đường đất đến đường phố.",
      galleryImages: [
        "https://images.unsplash.com/photo-1713839603530-8a3b3120c9d2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
      ...
      sections: [
        {
          ...
          content:
            "Trang bị động cơ brushless 750W Bafang (Đức) với mô-men xoắn cao, cho phép leo dốc 30 độ dễ dàng. Tốc độ tối đa lên đến 35km/h. Hệ thống trợ lực PAS (Pedal Assist System) 5 cấp độ thông minh.",
          image:
        ...
        },
        {
          ...
          content:
            "Pin lithium 48V-20Ah cho phép di chuyển 80-100km mỗi lần sạc. Pin tháo rời tiện lợi, có thể sạc trực tiếp trên xe hoặc mang về nhà sạc. Tuổi thọ pin lên đến 1000 chu kỳ sạc.",
          image:
            "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
        {
          ...
          content:
            "Giảm sóc thủy lực trước có khóa và giảm sóc sau hành trình 80mm, hấp thụ sóc tốt trên mọi địa hình. Lốp xe địa hình 27.5 inch chống trượt, chống đâm thủng. Phanh đĩa thủy lực Shimano cực kỳ nhạy.",
          image:
            "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
      ],
    ...
    },
    {
      ...
      description:
        "Xe đạp điện gấp GreenBike Fold là giải pháp hoàn hảo cho người đi làm, sinh viên hoặc những ai sống trong không gian nhỏ. Gấp gọn chỉ trong 3 bước đơn giản, dễ dàng mang lên xe buýt, tàu điện hoặc cất trong cốp xe ô tô.",
      galleryImages: [
        "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1605271864611-58dd08d10547?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
      ...
      sections: [
        {
          ...
          content:
            "Cơ chế gấp 3 bước đơn giản chỉ mất 10 giây. Kích thước khi gấp chỉ 80x65x40cm, dễ dàng cất gọn trong góc phòng, dưới gầm bàn hoặc trong cốp xe. Khóa gấp chắc chắn, an toàn tuyệt đối khi sử dụng.",
          image:
            "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
        {
          ...
          content:
            "Trọng lượng chỉ 18kg nhưng vẫn trang bị động cơ 250W mạnh mẽ. Khung xe hợp kim nhôm cao cấp siêu nhẹ nhưng cực kỳ bền. Pin lithium 36V-10Ah giúp di chuyển 40-55km mỗi lần sạc.",
          image:
            "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
        {
          ...
          content:
            "Màn hình LED hiển thị tốc độ, quãng đường và mức pin. Đèn LED tự động bật khi trời tối. Phanh đĩa cơ học nhạy, yên xe có thể điều chỉnh độ cao phù hợp với mọi lứa tuổi. Giỏ đựng đồ phía trước tiện lợi.",
          image:
            "https://images.unsplash.com/photo-1605271864611-58dd08d10547?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
      ],
    ...
    },
    {
      ...
      heroImage:
        "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      description:
        "GreenBike Sport là dòng xe đạp điện cao cấp dành cho những người yêu thích tốc độ và phong cách thể thao. Thiết kế aerodynamic giảm lực cản gió, khung xe carbon nhẹ và động cơ công suất cao mang đến trải nghiệm lái đầy phấn khích.",
      galleryImages: [
        "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1713839603530-8a3b3120c9d2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
      ...
      sections: [
        {
          ...
          content:
            "Động cơ mid-drive 500W gắn trục giữa cho khả năng tăng tốc mượt mà và hiệu quả. Tốc độ tối đa 45km/h với 5 chế độ trợ lực. Hệ thống truyền động Shimano 21 tốc độ cho phép tùy chỉnh linh hoạt.",
          image:
            "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
        {
          ...
          content:
            "Khung xe làm từ carbon fiber siêu nhẹ chỉ 2.5kg nhưng cực kỳ bền và cứng cáp. Thiết kế aerodynamic giảm 30% lực cản gió so với xe thông thường. Sơn UV chống trầy xước và oxy hóa.",
          image:
            "https://images.unsplash.com/photo-1713839603530-8a3b3120c9d2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
        {
          ...
          content:
            "Màn hình LCD màu 4.3 inch hiển thị đầy đủ thông tin: tốc độ, công suất, nhịp đạp, GPS. Kết nối Bluetooth với smartphone để theo dõi lộ trình và thống kê. Cổng sạc USB tích hợp.",
          image:
            "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
      ],
    ...
    },
    {
      ...
      heroImage:
        "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      description:
        "GreenBike Premium là đỉnh cao của công nghệ xe đạp điện với thiết kế sang trọng, vật liệu cao cấp và trang bị công nghệ tiên tiến nhất. Mỗi chiếc xe được chế tác tỉ mỉ, kết hợp hoàn hảo giữa thẩm mỹ và công năng.",
      galleryImages: [
        "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1713839603530-8a3b3120c9d2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
      ...
      sections: [
        {
          ...
          content:
            "Khung xe titanium siêu nhẹ với hoàn thiện mạ chrome bóng gương. Yên da thật cao cấp Brooks England. Tay nắm da bò thật. Mỗi chi tiết đều được chế tác thủ công tinh xảo, thể hiện đẳng cấp của chủ nhân.",
          image:
            "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
        {
          ...
          content:
            "Màn hình cảm ứng TFT 5 inch với hệ điều hành riêng. Kết nối 4G/5G, GPS định vị chống trộm. Cảm biến vân tay khởi động. Hệ thống đèn LED tự động thích ứng. Camera hành trình tích hợp. Điều khiển giọng nói.",
          image:
            "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
        {
          ...
          content:
            "Động cơ Bosch Performance Line CX 750W cung cấp mô-men xoắn 85Nm. Pin lithium 48V-25Ah cho tầm hoạt động lên đến 150km. Sạc nhanh 80% trong 3 giờ. Phanh ABS chống bó cứng. Giảm sóc điều chỉnh điện tử.",
          image:
            "https://images.unsplash.com/photo-1713839603530-8a3b3120c9d2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
        },
      ],
    ...
    },
    {
      ...
      heroImage:
        "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      description:
        "GreenBike Kids được thiết kế đặc biệt cho trẻ em từ 6-14 tuổi với các tính năng an toàn tối đa. Tốc độ giới hạn, khung xe thấp dễ lên xuống, phanh nhạy và màu sắc vui tươi thu hút các bé.",
      galleryImages: [
        "https://images.unsplash.com/photo-1673969206245-7da3eb7cde76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1692668696893-d8e5fb0fadad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
        "https://images.unsplash.com/photo-1605271864611-58dd08d10547?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200",
  ...
  const productLine =
    productLines.find((p) => p.id === productId) || productLines[0];
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <button
            ...
            className="flex items-center gap-2 text-blue-800 hover:text-blue-700 transition"
          >
            <ChevronLeft size={20} />
      ...
      {/* Hero Section with Edit/Delete buttons */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <h1 className="text-white mb-4 text-[24px]">
                {productLine.name}
              </h1>
            ...
            <div className="flex gap-2">
              <Button
                ...
                className="gap-2 bg-white text-blue-800 hover:bg-blue-50"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Image Gallery */}
        <div className="mb-16">
          <h2 className="mb-6 text-center">Thư Viện Hình Ảnh</h2>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc chắn muốn xóa sản phẩm "{productLine.name}"? Hành động
